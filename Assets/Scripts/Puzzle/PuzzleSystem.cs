...
public class PuzzleSystem : SingletonMonoBehavior<PuzzleSystem>
{
    ...
    [SerializeField] private DigPuzzle digPuzzle;
    ...
    public void StartPuzzle(string puzzleID)
    {
        ...
        switch (puzzle.Type)
        {
            ...
            case PuzzleData.Puzzle.Water:
                ...
                break;
            case PuzzleData.Puzzle.Dig:
                digPuzzle.StartPuzzle(puzzle);
                break;
            case PuzzleData.Puzzle.Star:
                starPuzzle.StartPuzzle(puzzle);
                break;
            default:
